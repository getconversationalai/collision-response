...
import ApplicationForm from '@/components/signup/ApplicationForm'
import AuthTabs from '@/components/AuthTabs'

export const dynamic = 'force-dynamic'

export const metadata = {
  title: 'Sign up — Collision Ping',
  description: 'Sign up to receive real-time MVA alerts for your collision center.',
}
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        {/* Brand */}
        <div className="text-center mb-7 animate-scale-in">
          ...
          <h1 className="text-3xl font-extrabold gradient-text tracking-tight">Sign up for Collision Ping</h1>
        ...
        {/* Auth tabs */}
        <div className="max-w-[300px] mx-auto mb-8 animate-fade-in-up" style={{ animationFillMode: 'both' }}>
